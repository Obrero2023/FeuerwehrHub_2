...
import { rendervehiclechecklist } from './pages/vehicle_checklist.js';
...
registerRoute('#/vehicle_checklist',   rendervehiclechecklist, 'fahrzeugpruefung');
registerRoute('#/hlf1-inspection',     rendervehiclechecklist, 'fahrzeugpruefung');
registerRoute('#/hlf2-inspection',     rendervehiclechecklist, 'fahrzeugpruefung');
registerRoute('#/mtf-inspection',      rendervehiclechecklist, 'fahrzeugpruefung');
